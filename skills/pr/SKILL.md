...
<If: branch has merge conflicts with the base branch>
<Then: warn the user about the conflicts. Suggest resolving them before creating the PR, or create the PR anyway and note the conflicts.>
