...
For complex features requiring deep investigation across multiple subsystems, consider delegating to the `research` agent to map dependencies, trace data flows, and surface non-obvious constraints before drafting the spec.
